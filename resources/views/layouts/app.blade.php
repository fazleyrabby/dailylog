          ...
          window.addEventListener('keydown', e => {
              ...
              if (e.key === 'g' && document.activeElement.tagName !== 'INPUT' && document.activeElement.tagName !== 'TEXTAREA' && !document.activeElement.hasAttribute('contenteditable')) {
                  const handler = (event) => {
                      ...
                      else if (event.key === 'a') window.location.href = '/activity-log';
                ...
                >
                    ...
                    <div>
                        ...
                        <div class="space-y-0.5">
                            ...
                            <x-ui.sidebar-item href="/activity-log" :active="request()->is('activity-log*')">
                                <x-slot name="icon">
                                    <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" /></svg>
                                </x-slot>
                                Activity Log
                            </x-ui.sidebar-item>
                        </div>
