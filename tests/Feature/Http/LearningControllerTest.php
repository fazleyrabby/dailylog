...
class LearningControllerTest extends TestCase
{
    ...
    public function test_guest_cannot_access_learning(): void
    {
        $this->get(route('learning.index'))
            ->assertRedirect(route('auth.login'));
    }

    public function test_index_shows_user_learning_paths(): void
    {
    ...
    public function test_complete_unit_increments_completed_units(): void
    {
        $user = User::factory()->create();
        $path = Entry::factory()->for($user)->type(EntryType::Learning)->create([
            'title' => 'Active Topic',
        ...
        $this->assertEquals(1, $details->fresh()->completed_units);
        $this->assertEquals(10, $details->fresh()->progress);
    }
}
